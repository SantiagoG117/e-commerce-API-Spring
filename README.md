# e-commerce back-end service

This project contains the source code for the backend for an e-commerce application using Spring Boot. The API includes endpoints for:
